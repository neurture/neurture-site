    ...
    <main className="bg-[#f8f9fa]">
      <section className="max-w-[800px] mx-auto py-12 px-8">
        ...
        <p className="mb-6 leading-[1.6]">
          ...
          Neurture (the "App") and the website located at neurtureapp.com (the
          "Site"), operated by Neurture ("we," "us," or "our"). By using the App
          or Site, you agree to these Terms.
        </p>
        ...
        <p className="mb-6 leading-[1.6]">
          Neurture is not a medical device and does not provide medical care,
          diagnosis, or treatment. The App offers educational content and
          self‑help tools. It is not a substitute for professional clinical
          advice. If you are in crisis or believe you may harm yourself or
        ...
        <p className="mb-6 leading-[1.6]">
          You must be at least 13 years old to use the App. If you are between
          13 and the age of majority in your jurisdiction, you may only use the
          App under the supervision of a parent or legal guardian who agrees to
          these Terms.
        </p>
        ...
        <p className="mb-6 leading-[1.6]">
          Some features may require an account or paid subscription managed
          through Apple App Store or Google Play. Pricing and billing terms are
          presented at purchase and subject to each platform’s policies. You are
        ...
        <ul className="list-disc ml-6 mb-6 leading-[1.6]">
          <li>
            Do not use the App to post or transmit unlawful, harmful, or abusive
            content.
          </li>
          <li>
            Do not attempt to reverse engineer, decompile, or interfere with the
            App’s operation.
          </li>
          <li>
            Do not use the App in any manner that violates applicable laws or
            regulations.
          </li>
        </ul>
        ...
        <p className="mb-6 leading-[1.6]">
          The App, Site, and all related content are protected by intellectual
        ...
        <p className="mb-6 leading-[1.6]">
          Your use of the App and Site is also governed by our Privacy Policy,
          which describes how we collect, use, and safeguard information. Please
          review it at{" "}
          <a className="text-[#3b82f6]" href="/privacy-policy">
            /privacy-policy
          </a>
          .
        </p>
        ...
        <p className="mb-6 leading-[1.6]">
          ...
          DAMAGES, OR FOR ANY LOSS OF DATA OR PROFITS, ARISING OUT OF OR IN
        ...
        <p className="mb-6 leading-[1.6]">
          ...
          for any reason, including if you violate these Terms. You may stop
          using the App at any time. Some provisions, by their nature, survive
          termination.
        </p>
        ...
        <p className="mb-6 leading-[1.6]">
          ...
          and update the “Last Updated” date above. Your continued use of the
          App or Site constitutes acceptance of the revised Terms.
        </p>
        ...
        <p className="mb-6 leading-[1.6]">
          ...
          <a className="text-[#3b82f6]" href="mailto:support@neurtureapp.com">
            support@neurtureapp.com
          </a>
          .
        </p>
      </section>

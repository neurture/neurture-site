...
export default function SweetSobrietyQRSection() {
  const [isMobile, setIsMobile] = useState<boolean | null>(null);
  const branchLink = "https://1fk6i.app.link/qaO6vYLOhWb";
    ...
    return (
      <section className="py-8 sm:py-20 px-8 text-center flex flex-col items-center mb-12">
        <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-20 mb-8 w-full max-w-[800px]">
          <div className="min-w-[220px] h-[280px] bg-gray-200 animate-pulse rounded-lg"></div>
          <div className="min-w-[220px] h-[280px] bg-gray-200 animate-pulse rounded-lg"></div>
        </div>
      </section>
    );
  ...
  // Mobile users: Show Branch link buttons
  if (isMobile) {
    return (
      <section className="py-8 sm:py-20 px-8 text-center flex flex-col items-center mb-12">
        <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-20 mb-8 w-full max-w-[800px]">
  ...
  // Desktop users: Show large QR code section with instructions
  return (
    <section className="py-8 sm:py-20 px-8 text-center flex flex-col items-center mb-12">
      <h2 className="text-2xl sm:text-3xl font-serif font-bold text-[#0a0a23] mb-8">
        Get the Neurture App
      </h2>
      
      <div className="flex flex-col items-center max-w-md mx-auto mb-8">
        <div className="mb-6">
          <Image
            src="/images/neurture-sweet-sobriety-branch-qr.png"
            alt="Scan to download Neurture from Sweet Sobriety"
            width={240}
            height={240}
            className="w-[240px] h-[240px] rounded-xl shadow-lg"
          />
        </div>
        <h3 className="text-xl font-semibold text-[#0a0a23] mb-3">
          Scan with your phone to download Neurture
        </h3>
        <p className="text-base text-[#6b7280] mb-6 leading-relaxed">
          Your journey to overcoming emotional eating starts with one simple scan.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          <a
            ...
            className="inline-flex items-center justify-center min-w-[200px] px-6 py-3 bg-black text-white rounded-lg hover:bg-gray-800 transition-colors"
          >
            <div className="mr-3">
              <svg viewBox="0 0 384 512" width="28" className="text-white">
                <path
                  fill="currentColor"
                  d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"
                ></path>
            ...
            <div>
              <div className="text-sm">View on</div>
              <div className="-mt-1 font-semibold">App Store</div>
            </div>
          </a>
          ...
          >
            <div className="mr-3">
              <svg viewBox="30 336.7 120.9 129.2" width="28" aria-hidden="true">
                <path
                  fill="#FFD400"
                  d="M119.2,421.2c15.3-8.4,27-14.8,28-15.3c3.2-1.7,6.5-6.2,0-9.7c-2.1-1.1-13.4-7.3-28-15.3l-20.1,20.2L119.2,421.2z"
                ></path>
            ...
            <div>
              <div className="text-sm">View on</div>
              <div className="-mt-1 font-semibold">Google Play</div>
            </div>
          </a>
        </div>
      </div>
      ...
      <div className="text-sm text-[#6b7280] max-w-md mx-auto">
        <p>
          Available on iOS and Android. The QR code will automatically detect your device and take you to the right app store.
        </p>
      </div>
    </section>
  );
